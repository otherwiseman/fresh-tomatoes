""" This module creates instances of
the Movie class. Those instances are then appended to a
list of movies, which calls the external rendering function.
"""
...
garden_state = media.Movie("Garden State",
                           "After many years away, a television bit actor returns to his hometown \
                           for his mother's funeral. There he is confronted by various aspects of the \
                           life he left behind, as he heals old wounds and forges new friendships.",
...
eternal_sunshine = media.Movie("Eternal Sunshine of the Spotless Mind",
                               ...
                               memories of her former boyfriend Joel from her mind. When Joel discovers \
...
dan_in_real_life = media.Movie("Dan in Real Life",
                               "Dan Burns, a widower and advice columnist, meets a beautiful stranger \
                               in a bookstore and is instantly smitten. Unfortunately the woman, named \
                               Marie, is already involved with Dan's charismatic brother.",
